...
_(No known open issues. Previously documented bugs were fixed in commit `83ebe51`:
`maxVolatility` added to `config.screening`, `get_wallet_positions` added to `MANAGER_TOOLS`.)_
