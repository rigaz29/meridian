...
WARNING: This executes a real on-chain transaction. Check DRY_RUN mode.`,
      parameters: {
        ...
        properties: {
          ...
          volatility: { type: "number", description: "Pool volatility at deploy time (0–7 scale). ALWAYS pass this — used to auto-scale range width: low vol→narrower range (higher fee concentration), high vol→wider range (fewer OOR exits)." },
...
Management: minClaimAmount, outOfRangeBinsToClose, outOfRangeWaitMinutes, downsideOorWaitMinutes, minVolumeToRebalance, stopLossPct, minAgeBeforeSL, pnlVelocitySLPct, pnlVelocityWindowSec, takeProfitFeePct, minSolToOpen, deployAmountSol, gasReserve, positionSizePct
