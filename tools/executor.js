...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      trailingDropScale: ["management", "trailingDropScale"],
      trailingDropMax: ["management", "trailingDropMax"],
      trailingOorTighten: ["management", "trailingOorTighten"],
      trailingRejectionCooldownSec: ["management", "trailingRejectionCooldownSec"],
